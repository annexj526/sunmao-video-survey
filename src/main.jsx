...
const ageOptions = ["Under 18", "18–24", "25–34", "35–44", "45–54", "55 or above"];
...
const likertItems = [
  ...
  [11, "I understood all parts of this video correctly."],
  ...
  return (
    <main className="container">
      <header className="header">
        <div>
          <p className="kicker">A Study on International Audience Perceptions of Chinese Cultural Storytelling</p>
      ...
      {step === "welcome" && (
        <section className="card">
          ...
          <p>
            You are invited to take part in an academic research study about international audience perceptions of Chinese cultural storytelling.
            You will first watch a short video about Chinese Sunmao culture and then complete a questionnaire about your perceptions and responses.
          </p>
          <p>
            Participation is voluntary. Your responses will be anonymous and used for academic research purposes only.
            You may stop participating at any time before submitting your responses.
          </p>
          <label className="consent">
            <input type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} />
            <span>I have read and understood the information above and agree to participate voluntarily.</span>
          </label>
        ...
        <>
          <section className="card">
            <div className="video-head">
              ...
              <div className="time-pill">{watchSeconds}s / {REQUIRED_WATCH_SECONDS}s</div>
            </div>
        ...
        <>
          <section className="card">
            <div className="section-intro">
              ...
              <p>Please answer the following questions based on your personal background and prior familiarity.</p>
            </div>

            <QuestionBlock id="A1" text="What is your age group?">
              <RadioGroup name="age_group" options={ageOptions} value={form.age_group} onChange={(v) => setAnswer("age_group", v)} />
            </QuestionBlock>

            <QuestionBlock id="A2" text="What is your gender?">
              <RadioGroup name="gender" options={genderOptions} value={form.gender} onChange={(v) => setAnswer("gender", v)} />
            </QuestionBlock>

            <QuestionBlock id="A3" text="Which country or cultural background do you primarily identify with?">
              <input
                className="text-input"
                value={form.country_background || ""}
                onChange={(e) => setAnswer("country_background", e.target.value)}
            ...
            <LikertQuestion
              ...
              onChange={(v) => setAnswer("chinese_culture_familiarity", v)}
            ...
            <LikertQuestion
              ...
              onChange={(v) => setAnswer("sunmao_attitude", v)}
              scaleLabels={["Very negative", "Very positive"]}
            />

            <div className="section-intro">
              <h2>Section B. Cultural Communication Effectiveness</h2>
              <p>Please indicate the extent to which you agree with the following statements.</p>
            ...
            {knowledgeItems.map((item) => (
              <QuestionBlock key={item.id} id={item.id} text={item.text}>
                <RadioGroup
                  ...
                  onChange={(v) => setAnswer(`q${item.id}`, v)}
                />
              </QuestionBlock>
            ))}
          </section>
...
function LikertQuestion({ id, text, value, onChange, scaleLabels = ["Strongly disagree", "Strongly agree"] }) {
  return (
